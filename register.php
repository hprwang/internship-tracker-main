        ...
        >
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input type="text" name="full_name" class="form-control" placeholder="Full name" pattern="[A-Za-z\s]+" title="Letters and spaces only — no numbers or symbols." oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '')" required>
            </div>
          </div>
