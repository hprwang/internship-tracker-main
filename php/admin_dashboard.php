...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .user-name { font-size: 0.875rem; font-weight: 600; display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; line-height: 1.3; }
...
function openModal(type) {
  ...
  const configs = {
    student: { title: 'Add Student', html: '<div class="form-group"><label class="form-label">Full Name</label><input type="text" name="full_name" class="form-control" pattern="[A-Za-z\\s]+" title="Letters and spaces only — no numbers or symbols." oninput="this.value = this.value.replace(/[^A-Za-z\\s]/g, \'\')" required></div><div class="form-group"><label class="form-label">Username</label><input type="text" name="username" class="form-control" required></div><div class="form-group"><label class="form-label">Email</label><input type="email" name="email" class="form-control" required></div><div class="form-group"><label class="form-label">Password</label><input type="password" name="password" class="form-control" required></div>' },
